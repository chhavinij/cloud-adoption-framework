...
For step-by-step guidance, you can also watch the [Migrate and Modernize Linux VMs and Databases into Azure](https://www.youtube.com/watch?v=1iskhkEtFNk&list=PLXtHYVsvn_b_lwPbu342oreT454QjrOLE&index=1) video. 
